...
/**
 * This is the item provider adapter for a {@link com.vogella.emf.webpage.model.webpage.Web} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WebItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Web_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Web_name_feature", "_UI_Web_type"),
						WebpagePackage.Literals.WEB__NAME, true, false, false,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Web_title_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Web_title_feature", "_UI_Web_type"),
						WebpagePackage.Literals.WEB__TITLE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Web_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Web_description_feature", "_UI_Web_type"),
						WebpagePackage.Literals.WEB__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addKeywordsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Web_keywords_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Web_keywords_feature", "_UI_Web_type"),
						WebpagePackage.Literals.WEB__KEYWORDS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Web_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(WebpagePackage.Literals.WEB__PAGES, WebpageFactory.eINSTANCE.createWebpage()));
	}
