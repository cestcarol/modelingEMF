...
/**
 * This is the item provider adapter for a {@link com.vogella.emf.webpage.model.webpage.Article} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArticleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Article_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Article_name_feature", "_UI_Article_type"),
						WebpagePackage.Literals.ARTICLE__NAME, true, false, false,
	...
	protected void addCreatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Article_created_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Article_created_feature",
								"_UI_Article_type"),
						WebpagePackage.Literals.ARTICLE__CREATED, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
